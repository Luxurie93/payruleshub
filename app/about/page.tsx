...
export const metadata: Metadata = {
  title: "About PayRulesHub | Free Payroll Calculators",
  description: "Learn about PayRulesHub and our mission to provide accurate, free payroll calculators.",
};
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <section className="mt-8 prose prose-sm max-w-none">
        <h2>Our Mission</h2>
        <p>
          PayRulesHub exists to make payroll calculations simple, free, and
        ...
        <p>
          PayRulesHub is <strong>not a substitute for professional advice.</strong>{" "}
