...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes = [
    ...
    ...stateHubRoutes,
    { path: '/blog/nevada-final-paycheck-calculator', changeFrequency: 'monthly', priority: 0.72 },
    { path: '/blog/connecticut-final-paycheck-calculator', changeFrequency: 'monthly', priority: 0.72 },
    { path: '/blog/tennessee-final-paycheck-calculator', changeFrequency: 'monthly', priority: 0.72 },
    { path: '/blog/minnesota-final-paycheck-calculator', changeFrequency: 'monthly', priority: 0.72 },
    ...
    { path: '/blog/arizona-final-paycheck-calculator', changeFrequency: 'monthly', priority: 0.72 },
    ...
    { path: '/blog/new-jersey-take-home-pay-calculator', changeFrequency: 'monthly', priority: 0.72 },
    { path: '/blog/ohio-take-home-pay-calculator', changeFrequency: 'monthly', priority: 0.72 },
