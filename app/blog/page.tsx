        ...
        {[
          {
            ...
            excerpt: 'Estimate an Indiana final paycheck with unpaid wages, overtime, commissions, vacation policy notes, deductions, and next-payday timing rules.',
            link: '/blog/indiana-final-paycheck-calculator',
          },
          {
          ...
          },
          {
            ...
            excerpt: 'Estimate a Maryland final paycheck with unpaid wages, overtime, policy-based vacation payout, deductions, and regular-payday final wage timing.',
            link: '/blog/maryland-final-paycheck-calculator',
          },
          {
            title: 'Nevada Final Paycheck Calculator: Estimate Final Wages',
            excerpt: 'Estimate a Nevada final paycheck with unpaid wages, overtime, commissions, PTO policy notes, deductions, and discharge vs resignation timing rules.',
            link: '/blog/nevada-final-paycheck-calculator',
          },
          {
          ...
          {
            title: 'Minnesota Final Paycheck Calculator: Estimate Final Wages',
            excerpt: 'Estimate a Minnesota final paycheck with unpaid wages, overtime, commissions, PTO policy notes, deductions, and final-pay timing rules.',
            link: '/blog/minnesota-final-paycheck-calculator',
          },
          {
          ...
          {
            title: 'North Carolina Final Paycheck Calculator: Estimate Final Wages',
            excerpt: 'Estimate a North Carolina final paycheck with unpaid wages, overtime, commissions, PTO policy notes, deductions, and next-payday final pay timing.',
            link: '/blog/north-carolina-final-paycheck-calculator',
          },
          {
            title: 'Washington Final Paycheck Calculator: Estimate Your Last Check',
            excerpt: 'Estimate a Washington final paycheck with unpaid wages, overtime, PTO policy notes, deductions, and next-payday final pay timing rules.',
            link: '/blog/washington-final-paycheck-calculator',
          },
          {
